...
const CHARACTERS = [
  ...
  // ══════════════════════════════════════════════
  {
    ...
    extras: [
      { type: 'brutality',  name: 'Brutality',  seq: ['GA','PA','GA','PA','PA','GA','PA','GA','PA','PB','GB'] },
      { type: 'animality',  name: 'Animality',  seq: ['↑','↑','↑','↓','↑'],   note: 'Pegado — tras Mercy', gif: 'cyrax_animality.gif' },
      { type: 'friendship', name: 'Friendship', seq: ['CR','CR','CR','↑','+','CR'], note: 'No bloquear', gif: 'cyrax_friendship.gif' },
      { type: 'babality',   name: 'Babality',   seq: ['→','→','←','+','GA'],   note: 'No bloquear', gif: 'cyrax_babality.gif' },
      { type: 'mercy',      name: 'Mercy',      seq: ['CR','CR','CR','PB'],    note: 'Desde distancia media', gif: 'cyrax_mercy.gif' },
    ],
  },
  ...
  // ══════════════════════════════════════════════
  {
    ...
    fatalities: [
      { name: 'Fatality 1',     seq: ['CR','BL','CR','CR','PA'],        note: 'Cerca',  gif: 'ermac_fatality1.gif' },
      { name: 'Fatality 2',     seq: ['↓','↑','↓','↓','↓','BL'],       note: 'Pegado', gif: 'ermac_fatality2.gif' },
      { name: 'Stage Fatality', seq: ['CR','CR','CR','CR','PB'] },
    ],
    extras: [
      { type: 'brutality',  name: 'Brutality',  seq: ['GA','PA','GB','BL','PA','PB','BL','GA','GB','PB','PA'] },
      { type: 'animality',  name: 'Animality',  seq: ['←','↓','←','→','BL'],  note: 'Pegado — tras Mercy', gif: 'ermac_animality.gif' },
      { type: 'friendship', name: 'Friendship', seq: ['→','→','→','GA'],       note: 'No bloquear', gif: 'ermac_friendship.gif' },
      { type: 'babality',   name: 'Babality',   seq: ['↓','↓','←','←','GA'],  note: 'No bloquear', gif: 'ermac_babality.gif' },
      { type: 'mercy',      name: 'Mercy',      seq: ['CR','CR','CR','PB'],    note: 'Desde distancia media', gif: 'ermac_mercy.gif' },
    ],
  },
  ...
  // ══════════════════════════════════════════════
  {
    ...
    extras: [
      { type: 'brutality',  name: 'Brutality',  seq: ['GA','PB','GA','GB','PA','PA','PB','BL','BL','GA','PA'] },
      { type: 'animality',  name: 'Animality',  seq: ['↑','↓','↑','↓','BL'],  note: 'Pegado — tras Mercy', gif: 'jade_animality.gif' },
      ...
      { type: 'mercy',      name: 'Mercy',      seq: ['CR','CR','CR','PB'],    note: 'Desde distancia media', gif: 'jade_mercy.gif' },
    ],
  },
  ...
  // ══════════════════════════════════════════════
  {
    ...
    extras: [
      { type: 'brutality',  name: 'Brutality',  seq: ['GA','GA','GA','BL','GB','GA','GA','GA','BL','GB','GA'] },
      { type: 'animality',  name: 'Animality',  seq: ['←','←','↓','←'],  note: 'Pegado — tras Mercy', gif: 'jax_animality.gif' },
      ...
      { type: 'mercy',      name: 'Mercy',      seq: ['CR','CR','CR','PB'],   note: 'Desde distancia media', gif: 'jax_mercy.gif' },
    ],
  },
  ...
  // ══════════════════════════════════════════════
  {
    ...
    extras: [
      { type: 'brutality',  name: 'Brutality',  seq: ['GA','BL','PB','PB','PA','GB','GB','GB','GA','GB','GB'] },
      ...
      { type: 'mercy',      name: 'Mercy',      seq: ['CR','CR','CR','PB'],         note: 'Desde distancia media', gif: 'kabal_mercy.gif' },
    ],
  },
  ...
  // ══════════════════════════════════════════════
  {
    ...
    extras: [
      { type: 'brutality',  name: 'Brutality',  seq: ['GA','GB','BL','GB','GA','BL','PA','PB','BL','PA','PB','PB'] },
      { type: 'animality',  name: 'Animality',  seq: ['↑','↑','↑'],  note: 'Pegado — tras Mercy', gif: 'kano_animality.gif' },
      ...
      { type: 'mercy',      name: 'Mercy',      seq: ['CR','CR','CR','PB'],          note: 'Desde distancia media', gif: 'kano_mercy.gif' },
    ],
  },
  ...
  // ══════════════════════════════════════════════
  {
    ...
    extras: [
      { type: 'brutality',  name: 'Brutality',  seq: ['GA','GA','BL','PA','BL','PB','BL','GB','BL','GA','BL'] },
      { type: 'animality',  name: 'Animality',  seq: ['↓','↑','↑','↑'],  note: 'Pegado — tras Mercy', gif: 'kitana_animality.gif' },
      ...
      { type: 'mercy',      name: 'Mercy',      seq: ['CR','CR','CR','PB'],        note: 'Desde distancia media', gif: 'kitana_mercy.gif' },
    ],
  },
  ...
  // ══════════════════════════════════════════════
  {
    ...
    extras: [
      { type: 'brutality',  name: 'Brutality',  seq: ['GA','GB','PB','PA','BL','GA','GB','PB','PA','BL','GA'] },
      { type: 'animality',  name: 'Animality',  seq: ['←','→','→','↓'],  note: 'Pegado — tras Mercy', gif: 'kunglao_animality.gif' },
      ...
      { type: 'mercy',      name: 'Mercy',      seq: ['CR','CR','CR','PB'],        note: 'Desde distancia media', gif: 'kunglao_mercy.gif' },
    ],
  },
  ...
  // ══════════════════════════════════════════════
  {
    ...
    extras: [
      { type: 'brutality',  name: 'Brutality',  seq: ['GA','GB','GA','BL','PB','PA','PB','PA','GB','GB','GA'] },
      { type: 'animality',  name: 'Animality',  seq: ['↓','↓','↓','↑'],  note: 'Pegado — tras Mercy', gif: 'liukang_animality.gif' },
      ...
      { type: 'mercy',      name: 'Mercy',      seq: ['CR','CR','CR','PB'],           note: 'Desde distancia media', gif: 'liukang_mercy.gif' },
    ],
  },
  ...
  // ══════════════════════════════════════════════
  {
    ...
    extras: [
      { type: 'brutality',  name: 'Brutality',  seq: ['GA','GB','GB','GA','BL','PA','PB','PA','BL','GA','GB'] },
      { type: 'animality',  name: 'Animality',  seq: ['B','F','B','F','BL'],  note: 'Pegado — tras Mercy', gif: 'mileena_animality.gif' },
      ...
      { type: 'mercy',      name: 'Mercy',      seq: ['CR','CR','CR','PB'],        note: 'Desde distancia media', gif: 'mileena_mercy.gif' },
    ],
  },
  ...
  // ══════════════════════════════════════════════
  {
    ...
    extras: [
      { type: 'brutality',  name: 'Brutality',  seq: ['GA','GA','PA','PB','PB','BL','GB','GB','GA','PA'] },
      { type: 'animality',  name: 'Animality',  seq: ['↑','↑','↑','↓'],  note: 'Pegado — tras Mercy', gif: 'nightwolf_animality.gif' },
      ...
      { type: 'mercy',      name: 'Mercy',      seq: ['CR','CR','CR','PB'],           note: 'Desde distancia media', gif: 'nightwolf_mercy.gif' },
    ],
  },
  ...
  // ══════════════════════════════════════════════
  {
    ...
    fatalities: [
      { name: 'Fatality 1',     seq: ['←','←','→','→','PA'], note: 'Media pantalla', gif: 'noob_fatality1.gif' },
      { name: 'Fatality 2',     seq: ['↓','↓','↑','CR'],                              gif: 'noob_fatality2.gif' },
      { name: 'Stage Fatality', seq: ['→','↓','→','BL'] },
    ],
    extras: [
      { type: 'brutality',  name: 'Brutality',  seq: ['GA','PB','GB','BL','PB','PA','GA','GB','BL','PB','PA'] },
      { type: 'animality',  name: 'Animality',  seq: ['↓','↓','↓','↑'],  note: 'Pegado — tras Mercy', gif: 'noob_animality.gif' },
      { type: 'friendship', name: 'Friendship', seq: ['→','→','←','GA'],  note: 'A toda pantalla — No bloquear', gif: 'noob_friendship.gif' },
      { type: 'babality',   name: 'Babality',   seq: ['→','→','→','GB'],  note: 'No bloquear', gif: 'noob_babality.gif' },
      { type: 'mercy',      name: 'Mercy',      seq: ['CR','CR','CR','PB'], note: 'Desde distancia media', gif: 'noob_mercy.gif' },
    ],
  },
  ...
  // ══════════════════════════════════════════════
  {
    ...
    fatalities: [],
    extras: [
      { type: 'brutality', name: 'Brutality', seq: ['GA','GA','BL','PB','PA','BL','PB','PA','BL','GA','GB'] },
      { type: 'animality',  name: 'Animality',  seq: ['↑','↑','↓','↓'],  note: 'Pegado — tras Mercy', gif: 'rain_animality.gif' },
      { type: 'mercy',     name: 'Mercy',     seq: ['CR','CR','CR','PB'], note: 'Desde distancia media', gif: 'rain_mercy.gif' },
    ],
  },
  ...
  // ══════════════════════════════════════════════
  {
    ...
    extras: [
      { type: 'brutality',  name: 'Brutality',  seq: ['GA','BL','PA','PA','BL','GA','GB','PB','PB','BL','GB'] },
      { type: 'animality',  name: 'Animality',  seq: ['←','↓','↓','BL'],  note: 'Pegado — tras Mercy', gif: 'reptile_animality.gif' },
      ...
      { type: 'mercy',      name: 'Mercy',      seq: ['CR','CR','CR','PB'],       note: 'Desde distancia media', gif: 'reptile_mercy.gif' },
    ],
  },
  ...
  // ══════════════════════════════════════════════
  {
    ...
    extras: [
      { type: 'brutality',  name: 'Brutality',  seq: ['GA','GA','BL','PA','PA','PB','PA','GA','GA','GB','GA'] },
      { type: 'animality',  name: 'Animality',  seq: ['→','↑','↑'],  note: 'Pegado — tras Mercy', gif: 'scorpion_animality.gif' },
      ...
      { type: 'mercy',      name: 'Mercy',      seq: ['CR','CR','CR','PB'],        note: 'Desde distancia media', gif: 'scorpion_mercy.gif' },
    ],
  },
  ...
  // ══════════════════════════════════════════════
  {
    ...
    extras: [
      { type: 'brutality',  name: 'Brutality',  seq: ['GA','GA','BL','BL','PA','PA','PB','PB','GB','GB','GA'] },
      { type: 'animality',  name: 'Animality',  seq: ['↑','↑','→'],  note: 'Pegado — tras Mercy', gif: 'sektor_animality.gif' },
      ...
      { type: 'mercy',      name: 'Mercy',      seq: ['CR','CR','CR','PB'],         note: 'Desde distancia media', gif: 'sektor_mercy.gif' },
    ],
  },
  ...
  // ══════════════════════════════════════════════
  {
    ...
    extras: [
      { type: 'brutality',  name: 'Brutality',  seq: ['GA','BL','BL','BL','PB','GA','GB','GB','BL','BL','BL'] },
      { type: 'animality',  name: 'Animality',  seq: ['→','↑','→'],  note: 'Pegado — tras Mercy', gif: 'shang_animality.gif' },
      ...
      { type: 'mercy',      name: 'Mercy',      seq: ['CR','CR','CR','PB'],     note: 'Desde distancia media', gif: 'shang_mercy.gif' },
    ],
  },
  ...
  // ══════════════════════════════════════════════
  {
    ...
    extras: [
      { type: 'brutality',  name: 'Brutality',  seq: ['GA','BL','PB','BL','PB','PA','BL','PA','PA','PB','BL','GB'] },
      { type: 'animality',  name: 'Animality',  seq: ['←','←','↓','←'],  note: 'Pegado — tras Mercy', gif: 'sindel_animality.gif' },
      ...
      { type: 'mercy',      name: 'Mercy',      seq: ['CR','CR','CR','PB'], note: 'Desde distancia media', gif: 'sindel_mercy.gif' },
    ],
  },
  ...
  // ══════════════════════════════════════════════
  {
    ...
    extras: [
      { type: 'brutality',  name: 'Brutality',  seq: ['GA','PB','PB','PA','BL','BL','GB','GB','GA','BL','BL'] },
      { type: 'animality',  name: 'Animality',  seq: ['→','↑','↑'],  note: 'Pegado — tras Mercy', gif: 'smoke_animality.gif' },
      ...
      { type: 'mercy',      name: 'Mercy',      seq: ['CR','CR','CR','PB'],       note: 'Desde distancia media', gif: 'smoke_mercy.gif' },
    ],
  },
  ...
  // ══════════════════════════════════════════════
  {
    ...
    extras: [
      { type: 'brutality',  name: 'Brutality',  seq: ['GA','PB','BL','GA','PB','BL','GA','GB','BL','PA','PB'] },
      { type: 'animality',  name: 'Animality',  seq: ['↑','↑','↓'],  note: 'Pegado — tras Mercy', gif: 'sonya_animality.gif' },
      ...
      { type: 'mercy',      name: 'Mercy',      seq: ['CR','CR','CR','PB'],        note: 'Desde distancia media', gif: 'sonya_mercy.gif' },
    ],
  },
  ...
  // ══════════════════════════════════════════════
  {
    ...
    extras: [
      { type: 'brutality',  name: 'Brutality',  seq: ['GA','GB','PA','PB','GA','GB','PB','PA','GA','PB','PB'] },
      { type: 'animality',  name: 'Animality',  seq: ['←','←','↓'],  note: 'Pegado — tras Mercy', gif: 'stryker_animality.gif' },
      ...
      { type: 'mercy',      name: 'Mercy',      seq: ['CR','CR','CR','PB'],       note: 'Desde distancia media', gif: 'stryker_mercy.gif' },
    ],
  },
  ...
  // ══════════════════════════════════════════════
  {
    ...
    extras: [
      { type: 'brutality',  name: 'Brutality',  seq: ['GA','PB','PA','GB','GA','PA','PA','GA','GA','GB','GA'] },
      { type: 'animality',  name: 'Animality',  seq: ['→','↓','→','BL'],  note: 'Pegado — tras Mercy', gif: 'subzero_animality.gif' },
      ...
      { type: 'mercy',      name: 'Mercy',      seq: ['CR','CR','CR','PB'],          note: 'Desde distancia media', gif: 'subzero_mercy.gif' },
    ],
  },
  ...
  // ══════════════════════════════════════════════
  {
    ...
    extras: [
      { type: 'brutality',  name: 'Brutality',  seq: ['GA','GB','GA','BL','PB','PB','PA','PA','PA','GB','GA','GB'] },
      { type: 'animality',  name: 'Animality',  seq: ['→','↓','→','BL'],  note: 'Pegado — tras Mercy', gif: 'classicsz_animality.gif' },
      { type: 'friendship', name: 'Friendship', seq: ['PA','CR','CR','↑'],  note: 'Pegado — No bloquear', gif: 'classicsz_friendship.gif' },
      { type: 'babality',   name: 'Babality',   seq: ['↓','←','←','PA'],   note: 'No bloquear', gif: 'classicsz_babality.gif' },
      { type: 'mercy',      name: 'Mercy',      seq: ['CR','CR','CR','PB'], note: 'Desde distancia media', gif: 'classicsz_mercy.gif' },
    ],
  },
  ...
  // ══════════════════════════════════════════════
  {
    ...
    extras: [
      { type: 'brutality',  name: 'Brutality',  seq: ['GA','GA','BL','GA','GA','BL','GA','GA','BL','GA','GA'] },
      ...
      { type: 'mercy',      name: 'Mercy',      seq: ['CR','CR','CR','PB'],       note: 'Desde distancia media', gif: 'sheeva_mercy.gif' },
    ],
  },
  ...
  // ══════════════════════════════════════════════
  {
    ...
    fatalities: [
      { name: 'Fatality 1',     seq: ['→','→','←','CR'], note: 'Distancia de barrido', gif: 'hsmoke_fatality1.gif' },
      { name: 'Stage Fatality', seq: ['→','↑','↑','GB'] },
    ],
    extras: [
      { type: 'brutality',  name: 'Brutality',  seq: ['GA','PB','PB','PA','BL','BL','GB','GB','GA','GA','BL'] },
      { type: 'animality',  name: 'Animality',  seq: ['→','↑','↑'],  note: 'Pegado — tras Mercy', gif: 'hsmoke_animality.gif' },
      { type: 'friendship', name: 'Friendship', seq: ['↓','→','→','→','CR'],  note: 'No bloquear', gif: 'hsmoke_friendship.gif' },
      { type: 'babality',   name: 'Babality',   seq: ['←','←','→','CR'],      note: 'No bloquear', gif: 'hsmoke_babality.gif' },
      { type: 'mercy',      name: 'Mercy',      seq: ['CR','CR','CR','PB'],    note: 'Desde distancia media', gif: 'hsmoke_mercy.gif' },
    ],
  },
